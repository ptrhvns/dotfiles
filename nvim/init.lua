...
vim.api.nvim_create_autocmd("FileType", { group = augroup, pattern = "javascript", command = "setlocal expandtab" })
...
vim.api.nvim_create_autocmd("FileType", { group = augroup, pattern = "typescript", command = "setlocal expandtab" })
vim.api.nvim_create_autocmd("FileType", { group = augroup, pattern = "typescript", command = "setlocal softtabstop=2" })
vim.api.nvim_create_autocmd("FileType", { group = augroup, pattern = "typescript", command = "setlocal tabstop=2" })
vim.api.nvim_create_autocmd("FileType", { group = augroup, pattern = "typescriptreact", command = "setlocal expandtab" })
vim.api.nvim_create_autocmd("FileType", { group = augroup, pattern = "typescriptreact", command = "setlocal softtabstop=2" })
vim.api.nvim_create_autocmd("FileType", { group = augroup, pattern = "typescriptreact", command = "setlocal tabstop=2" })
